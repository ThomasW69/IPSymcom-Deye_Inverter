...
class SUNxxKSG04LP3 extends Deye
{
	...
	//Name, VarType, Profile,Address,Function,Quantity, Keep
        ['Inverter Voltage L1', 	VARIABLETYPE_INTEGER, 	'Volt.I', 		154, 0x03, 2, 0.1, true],
        ['Inverter Voltage L2', 	VARIABLETYPE_INTEGER, 	'Volt.I', 		155, 0x03, 2, 0.1, true],
        ...
        ['Load Voltage L1', 		VARIABLETYPE_INTERGER, 	'Volt.I', 		157, 0x03, 2, 1,   true],  //Spannung am Load Phase L1
        ['Load Voltage L2', 		VARIABLETYPE_INTERGER, 	'Volt.I', 		158, 0x03, 2, 1,   true],   //Spannung am Load Phase L2
