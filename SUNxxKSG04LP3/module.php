...
*/
    ...
    ['DC_Trans_Temp', 	VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    '', 	   540,     3, 3, 0.1,   1000,  true],
    ['Batt_Temp',    	VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    '', 	   586,     3, 3, 0.1,   1000,  true],
    ['Batt_V',      	VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    '', 	   587,     3, 1, 0.01,   1000,  true],
    ['Batt_Lvl',      	VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    '', 	   588,     3, 1,    1,   1000,  true],
    ['Batt_I',      	VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    '', 	   591,     3, 1, 0.01,   1000,  true]
	];
}
