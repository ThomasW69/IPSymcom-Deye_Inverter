...
class SUNxxKSG04LP3 extends Deye
{
    ...
    ['Day_ActGen_Power',      	VARIABLETYPE_FLOAT,     VALTYPE_SWORD,	    'Electricity.I', 	   501,     3, 1,  0.1,  0,  true], // Gesamterzeugung heute 
    ['Day_Bat_Charge',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   514,     3, 1,  0.1,  0,  true], // //Batterieladung heute kWh
    ['Total_Bat_Charge',      	VARIABLETYPE_FLOAT,     VALTYPE_DWORD,	    'Electricity.I', 	   516,     3, 2,  0.1,  0,  true], // Batterieladung gesamt [kWh]
    ['Total_Bat_Discharge',     VARIABLETYPE_FLOAT,     VALTYPE_DWORD,	    'Electricity.I', 	   518,     3, 2, 0.01,  0,  true], // Batterieentladung total [kW]h
    ['Day_GridBuy_Power Wh',    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   520,     3, 1, 0.01,  0,  true], // Netzbezug heute [kWh]
    ['Day_GridSell_Power Wh',   VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   521,     3, 1, 0.01,  0,  true], // Einspeisung heute [kWh]
    ['Total_GridBuy_Power',     VARIABLETYPE_FLOAT,     VALTYPE_DWORD,	    'Electricity.I', 	   522,     3, 1,  0.1,  0,  true], // Gesamter Netzbezug [kWh]
    ['Total_GridSell_Power',    VARIABLETYPE_FLOAT,     VALTYPE_DWORD,	    'Electricity.I', 	   524,     3, 1,  0.1,  0,  true], // Gesamte Einspeisung [kWh]
    ['Day_Load_Power ',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   526,     3, 1,  0.1,  0,  true], //  Hausverbrauch  heute [kWh]
    ['Total_Load_Power',      	VARIABLETYPE_FLOAT,     VALTYPE_DWORD,	    'Electricity.I', 	   527,     3, 2,  0.1,  0,  true], // Gesamtverbrauch [kWh]
    ['Day_PV_Power Wh',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   529,     3, 1,  0.1,  0,  true], //  Solarerzeugung heute [kWh]
    ['Day_PV-1_Power Wh',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   530,     3, 1,  0.1,  0,  true], //  Solarerzeugung heute String 1 [kWh]
    ['Day_PV-2_Power Wh',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   531,     3, 1,  0.1,  0,  true], //  Solarerzeugung heute String 2[kWh]
    ['Day_PV-3_Power Wh',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   532,     3, 1,  0.1,  0,  true], //  Solarerzeugung heute String 3[kWh]
    ['Day_PV-4_Power Wh',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Electricity.I', 	   533,     3, 1,  0.1,  0,  true], //  Solarerzeugung heute String 4[kWh]
    ['Total	PV_power Wh',      	VARIABLETYPE_FLOAT,     VALTYPE_DWORD,	    'Electricity.I', 	   534,     3, 1,  0.1,  0,  true], // Solarerzeugung Gesamt [kWh]
    ...
    ['Bat_Voltage',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Volt.I', 	   587,     3, 1, 0.01,  0,  true], //Battereispannung [V]
    ['Bat_Level',      	        VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    'Intensity.F', 588,     3, 1,    1,  0,  true], //Batterielevel [%]
    ['Bat_Out_Power',      	    VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    'Watt.I', 	   590,     3, 1,    1,  0,  true], //Batterieausgangsleistung [W]
    ['Bat_Out_Curr',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Ampere.I', 	   591,     3, 1, 0.01,  0,  true], //Batterieausgangsstrom [A] 
    ['Bat_Capacyty',      	    VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    'AmpHour.I', 	   592,     3, 1,    1,  0,  true], //Batteriekapazität [Ah] 
    ['Grid_L1_Voltage',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Volt.I', 	   598,     3, 1,  0.1,  0,  true], // Netz Spannung Phase L1 [V]
    ['Grid_L2_Voltage',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Volt.I', 	   599,     3, 1,  0.1,  0,  true], // Netz Spannung Phase L2 [V]
    ['Grid_L3_Voltage',      	VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Volt.I', 	   600,     3, 1,  0.1,  0,  true], // Netz Spannung Phase L3 [V]
    ['Out_Grid_Total_Power',    VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    'Watt.I', 	   619,     3, 1,    1,  0,  true], // Gesamtleistung aus Netz [W]
    ['Inverter_Freq',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Hertz.I', 	   638,     3, 1, 0.01,  0,  true], // //Inverterfequqnz [Hz]
//Load
...
//PV
    ...
    ['DC1_Voltage',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Volt.I', 	   676,     3, 1,  0.1,  0,  true], // DC1 Eingangsspannung [V]
    ['DC1_Current',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Ampere.I', 	   677,     3, 1,  0.1,  0,  true], // DC1 EingangssStrom [A]
    ['DC2_Voltage',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Volt.I', 	   678,     3, 1,  0.1,  0,  true], // DC2 Eingangsspannung [V]
    ['DC2_Current',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Ampere.I', 	   679,     3, 1,  0.1,  0,  true], // DC2 EingangssStrom [A]
    ['DC3_Voltage',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Volt.I', 	   680,     3, 1,  0.1,  0,  true], // DC3 Eingangsspannung [V]
    ['DC3_Current',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Ampere.I', 	   681,     3, 1,  0.1,  0,  true], // DC3 EingangssStrom [A]
    ['DC4_Voltage',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Volt.I', 	   682,     3, 1,  0.1,  0,  true], // DC4 Eingangsspannung [V]
    ['DC4_Current',      	    VARIABLETYPE_FLOAT,     VALTYPE_WORD,	    'Ampere.I', 	   683,     3, 1,  0.1,  0,  true] // DC4 EingangssStrom [A]
];
}
