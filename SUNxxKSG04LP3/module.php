...
*/
    ...
    ['DC_Trans_Temp', 	VARIABLETYPE_FLOAT,   VALTYPE_WORD,	    'Temperature', 	   540,     3, 1, 0.1,   1000,  true],
    ['Batt_Temp',    	VARIABLETYPE_FLOAT,   VALTYPE_WORD,	    'Temperature', 	   586,     3, 1, 0.1,   1000,  true],
    ['Batt_V',      	VARIABLETYPE_FLOAT,   VALTYPE_WORD,	    '', 	   587,     3, 1, 0.01,  0,  true],
    ['Batt_Lvl',      	VARIABLETYPE_INTEGER,   VALTYPE_WORD,	    'Percent', 588,     3, 1,    1,  0,  true],
    ['Batt_I',      	VARIABLETYPE_FLOAT,   VALTYPE_WORD,	    '', 	   591,     3, 1, 0.01,  0,  true]
	];
}
